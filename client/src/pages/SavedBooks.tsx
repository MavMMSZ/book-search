...
const SavedBooks = () => {
  ...
  // Create method to delete a book from the database
  const handleDeleteBook = async (bookId: string) => {
    try {
      await removeBook({
        variables: { bookId },
      ...
      // Update user data by filtering out the removed book
      userData({
        ...userData,
        savedBooks: userData.savedBooks.filter((book: { bookId: string }) => book.bookId !== bookId),
      });
